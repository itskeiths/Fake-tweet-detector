...
export default function Login() {
  ...
  return (
    <main className="flex justify-center items-center h-screen bg-gray-100 relative overflow-hidden bg-[url('/img/sign-in.jpg')] bg-no-repeat bg-cover ">
      ...
      <Card className="w-[350px] md:w-[400px] lg:w-[450px] xl:w-[500px] mx-auto">
        <CardHeader>
          <CardTitle className="text-center text-3xl font-bold mb-4">Fake Review Detector</CardTitle>
